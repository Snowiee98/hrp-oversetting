Config = {
    ...
    StarterApartment = {
        ...
        BuildingId = 2,             -- The building id of the starter apartment
        Address = "Integrity Way 51",     -- The address of the starter apartment
        Name = "Starter2", -- The name of the starter apartment
        ...
        Interior = {
            ...
            name = "Modern Hotel",     -- The name of the shell or ipl
        },
        Inventory = {
